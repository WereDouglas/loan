...
<div class="widget-box transparent">
    ...
    Users
                                                            ...
                                                            ?>  "<?=$loop->name?>",<?php }} ?>"Other"]'>
                                        <i class="icon-4x orange"></i><a target="frame" href="<?php echo base_url() . "index.php/user/add"; ?>" class="btn btn-small btn-grey"><i class="icon-add"></i>Add</a>
        <a target="frame" href="<?php echo base_url() . "index.php/user"; ?>" class="btn btn-small btn-primary">  <i class="icon-list"></i>List</a>
