...
<header id="header_wrapper">
  <div class="container">
    <div class="header_box">
      <div class="logo"><a href="#"><img  height="80px" width="450px" class="nav-user-photo" src="<?= base_url(); ?>images/header1.png" alt="account" /></a></div>
      ...
      <div class="navbar-header">
	    ...
	    <div id="main-nav" class="collapse navbar-collapse navStyle">
			<ul class="nav navbar-nav" id="mainNav">
			  ...
			  <li><a href="#clients" class="scroll-link">Information</a></li>
			  <li><a href="#team" class="scroll-link">View</a></li>
